...
<table class="global width-100" cellpadding="0" cellspacing="0">
	...
	<tbody>
		...
		if ($users) {
			...
			<td><span class='bold'><a href='/verwaltung/einstellungen/benutzer/".$row->userID."'>".$row->username."</a></strong></td>
			<td>".$row->realname."</td>
			<td>".$row->email."</td>
			...
			echo"<a href='#this' id='disable-".$row->userID."' class='modalactivate' ".$hidden1.">
				<img src='/images/icons/ui-check-box.png' alt='Disable' title='Disable' /></a>";
			echo"<a href='#this' id='enable-".$row->userID."' class='modalactivate' ".$hidden2.">
				<img src='/images/icons/ui-check-box-uncheck.png' alt='Enable' title='Enable' /></a>";
			echo "</td>
