...
<div class="content res-height">
	...
	<p>
		<?php echo Config::get('cuisines')[($row->cuisine_style-1)];?>
	</p>
	...
	<p>		
		...
		echo "<input type='text' name='' class='width-450' value='" . Config::get('app.url') . "/api/reserve.php?outletID=".$row->outlet_id."'/>";
		echo "<br/><span class='bold'>"._property." :</span><br/>";
		echo "<input type='text' name='' class='width-450' value='" . Config::get('app.url') . "/api/reserve.php?propertyID=".$row->property_id."'/>";
		?>
	</p>	 	 	 	 	 	 	
...
<div class="twocolumn_wrapper right">
	<div class="twocolumn" >
		<div class="content res-height">		 	 	 	 	 	 		 	 	 	 	 	 				 	 	 	 	 	 	 
			...
			<p>		
				<?php echo buildDate(Config::get('general.dateformat_short'),substr($row->saison_start,2,2),substr($row->saison_start,0,2));?>
			</p>			 	 	 	 	 	 	 
			<label><?php echo _season_end;?></label>	
			<p>		
				<?php echo buildDate(Config::get('general.dateformat_short'),substr($row->saison_end,2,2),substr($row->saison_end,0,2));?>
			</p>
			...
			<p>		 	 	 	 	 	 	
				<?php
					echo formatTime($row->outlet_open_time,Config::get('general.timeformat'));
					echo " - "; 	 	 	 	 	 	
					echo formatTime($row->outlet_close_time,Config::get('general.timeformat'));
				?>
			</p>		 	 	 	 	 	 	 		 	 	 	 	 	 	 
			<br/>
