...
?>	
		...
		<ul class="second_level_tab">
			...
			<li>
				<a href="/verwaltung/einstellungen/outlets" class="button_dark">
					<?php echo _back;?>
				</a>
			<li/>
		</ul>
...
<div id="show">
	<div class="twocolumn_wrapper">
	 <div class="twocolumn">
			<?php 
				echo (new View('system' . DS . 'outlets' . DS . 'outletsDetail', ['row' => $row]))->render();
			?>
	 </div>
	</div> <!-- end detail -->
</div>
	...
	<div class="twocolumn_wrapper">
	 <div class="twocolumn">
		...
		<form method="post" action="/verwaltung/einstellungen/outlets" id="edit_outlet_form">
			...
			<p>
				<?php echo cuisineDropdown($row->cuisine_style);?>
			</p>
			<br/>
			...
			<p>	 	 	 	 	 	 			
					<?php getDurationList(Config::get('general.timeintervall'),'avg_duration',$row->avg_duration);?>
			</p>
		...
		<div class="twocolumn_wrapper right">
			<div class="twocolumn" >
				<div class="content form-height">
					...
					<p>		 	 	 	 	 	 	
						<?php 
							getTimeList(Config::get('general.timeformat'), Config::get('general.timeintervall'), 'outlet_open_time',$row->outlet_open_time);
							echo " ";
							getTimeList(Config::get('general.timeformat'), Config::get('general.timeintervall'), 'outlet_close_time',$row->outlet_close_time);
						?>
					</p>
					<br/>
						...
						<table class='opentime-table'>
						 <?php
							...
							for ($i=1; $i <= 7; $i++) { 
								...
								getTimeList(Config::get('general.timeformat'), Config::get('general.timeintervall'), $field_open,$row->$field_open);
								echo " ";
								getTimeList(Config::get('general.timeformat'), Config::get('general.timeintervall'), $field_close,$row->$field_close);
								echo "<br/></td></tr>";
								$day = $day + 86400;
							}
						 ?>	
		...
		<br class="clear">
		<br/>
			<a href="/verwaltung/einstellungen/outlets" class="button_dark"><input type="button" class="button_dark" value="<?php echo _back;?>"/></a>
		<br/>
