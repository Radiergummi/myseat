...
?>
	...
	<ul class="first_level_tab">
		...
		<li>
			<a href="/verwaltung/einstellungen/outlets" <?php if ($subtab == 1) { echo " class='active'";}?> >
		...
		<li>
			<a href="/verwaltung/einstellungen/benutzer" <?php if ($subtab == 2) { echo " class='active'";}?> >
		...
		<?php if ( current_user_can( 'Settings-General' ) ): ?>
			<li>
				<a href="/verwaltung/einstellungen/optionen" <?php if ($subtab == 3) { echo " class='active'";}?> >
		...
		<?php if ( current_user_can( 'Settings-Events' ) ): ?>
			<li>
				<a href="/verwaltung/einstellungen/veranstaltungen" <?php if ($subtab == 4) { echo " class='active'";}?> >
		...
		<?php if ( current_user_can( 'Property-New' ) ): ?>
			<li>
				<a href="/verwaltung/einstellungen/objekt" <?php if ($subtab == 5) { echo " class='active'";}?> >
		...
		<?php if ( current_user_can( 'Settings-General' ) ): ?>
			<li>
				<a href="/verwaltung/einstellungen/plugins" <?php if ($subtab == 7) { echo " class='active'";}?> >
	...
	<div class="onecolumn">
		...
		<div class="header">
			<div class="description">
				<?php
				if ($subtab == 1 && $_SESSION['button'] == 1) { 
					echo "<h3>"._existing_outlets."</h3>";
				}else if ($subtab == 1 && $_SESSION['button'] == 2) { 
					echo "<h3>"._add_outlet."</h3>";
				}else if (	$subtab == 2 && $_SESSION['button'] == 1) { 
					echo "<h3>"._users."</h3>";
				}else if ($subtab == 2 && $_SESSION['button'] == 2) { 
					echo "<h3>"._add_user."</h3>";
				}else if ($subtab == 2 && $_SESSION['button'] == 3) { 
					echo "<h3>"._edit." "._users."</h3>";
				}else if ($subtab == 3 ) { 
					echo "<h3>"._general." "._settings."</h3>";
				}else if ($subtab == 4 ) { 
					echo "<h3>"._sp_events."</h3>";
				}else if ($subtab == 5 || $subtab == 6) { 
			...
			<ul class="second_level_tab">
				<li>
					<a href="/verwaltung/einstellungen/outlets/aktiv" <?php if ($_SESSION['button'] == 1) { echo " class='active'";}?> >
						<?php echo _active;?>
					</a>
				</li>
				<li>
					<a href="/verwaltung/einstellungen/outlets/inaktiv" <?php if ($_SESSION['button'] == 3) { echo " class='active'";}?> >
						<?php echo 'In'._active;?>
					</a>
				</li>
				<li>
					<a href="/verwaltung/einstellungen/outlets/neu" <?php if ($_SESSION['button'] == 2) { echo " class='active'";}?> >
						<?php echo _create;?>
					</a>
				</li>
				<li>
					...
					if ($_SESSION['button'] == 2 || $_SESSION['button'] == 3) {
						echo "/verwaltung/einstellungen/outlets";
					}else{
						echo "/verwaltung/reservierungen/".$_SESSION['outletID'];
					}
					echo '">'._back;
					?>
					</a>
			...
			<ul class="second_level_tab">
				<li>
					<a href="/verwaltung/einstellungen/benutzer" <?php if ($_SESSION['button'] == 1) { echo " class='active'";}?> >
						<?php echo _users;?>
					</a>
				</li>
				<li>
					<a href="/verwaltung/einstellungen/benutzer/neu" <?php if ($_SESSION['button'] == 2 || $_SESSION['button'] == 3) { echo " class='active'";}?> >
						<?php echo _create;?>
					</a>
				</li>
				<li>
					...
					echo'<a href="';
					if ($_SESSION['button'] == 2 || $_SESSION['button'] == 3) {
						echo "/verwaltung/einstellungen/benutzer";
					}else{
						echo "/verwaltung/reservierungen/".$_SESSION['outletID'];
					}
					echo '">'._back;
			...
			<ul class="second_level_tab">
				<li>
					<a href="/verwaltung/reservierungen/<?php echo $_SESSION['outletID']; ?>">
						<?php echo _back;?>
					</a>
				</li>
			</ul>
			...
			<ul class="second_level_tab">
				<li>
					<a href="/verwaltung/einstellungen/veranstaltungen" <?php if ($_SESSION['button'] == 1) { echo " class='active'";}?> >
						<?php echo _overview;?>
					</a>
				</li>
				<li>
					<a href="/verwaltung/einstellungen/veranstaltungen/neu" <?php if ($_SESSION['button'] == 2 || $_SESSION['button'] == 3) { echo " class='active'";}?> >
						<?php echo _create;?>
					</a>
				</li>
				<li>
					...
					echo'<a href="';
					if ($_SESSION['button'] == 2 || $_SESSION['button'] == 3) {
						echo "/verwaltung/einstellungen/veranstaltungen";
					}else{
						echo "/verwaltung/reservierungen/" . $_SESSION['outletID'];
					}
					echo '">'._back;
