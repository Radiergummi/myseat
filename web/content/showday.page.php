	...
	<ul class="first_level_tab">
		<li>
		<a href="/verwaltung/reservierungen" <?php if ($q == 1 || $q == 4) { echo " class='active'";}else{ echo " class='inactive'"; }?> >
				<?php 
				if ($q == 4){
					echo _search;	
				}else{
		...
		<?php if ($q != 4):?>
		<li>
			<a href="/verwaltung/reservierungen/storniert" <?php if ($q == 3) { echo " class='active'";}else{ echo " class='inactive'"; }?> >
